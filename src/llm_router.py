...
EMAIL_ROUTER_SYSTEM_PROMPT = (
    ...
    "drains queue.\n"
    "- chat_commit_project(project, message): escape hatch for a dirty "
    "repo that's blocking task execution. Runs `git add -A && "
    "git commit -m <message>` directly (no claude). Use for 'commit "
    "these changes', 'save what's there', 'WIP commit'.\n"
    ...
    "X\" → chat_commit_project (use the user's suggested message if any, "
    "else 'WIP via email')\n"
