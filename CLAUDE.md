...
- **Test runner**: pytest (422 tests, 100% coverage)
...
├── tests/                 # 422 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 422 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 422 tests pass
