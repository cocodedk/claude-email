...
- **Test runner**: pytest (529 tests, 100% coverage)
...
├── tests/                 # 529 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 529 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 529 tests pass
