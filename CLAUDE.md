...
- **Test runner**: pytest (453 tests, 100% coverage)
...
├── tests/                 # 453 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 453 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 453 tests pass
