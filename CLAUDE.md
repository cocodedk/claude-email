...
- **Test runner**: pytest (982 tests, 100% coverage)
...
├── tests/                 # 982 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 982 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 982 tests pass
