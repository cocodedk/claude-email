...
- **Test runner**: pytest (945 tests, 100% coverage)
...
├── tests/                 # 945 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 945 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 945 tests pass
