...
- **Test runner**: pytest (670 tests, 100% coverage)
...
├── tests/                 # 670 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 670 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 670 tests pass
