...
- **Test runner**: pytest (943 tests, 100% coverage)
...
├── tests/                 # 943 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 943 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 943 tests pass
