...
- **Test runner**: pytest (442 tests, 100% coverage)
...
├── tests/                 # 442 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 442 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 442 tests pass
