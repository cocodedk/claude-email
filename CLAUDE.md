...
- **Test runner**: pytest (488 tests, 100% coverage)
...
├── tests/                 # 488 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 488 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 488 tests pass
