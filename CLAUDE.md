...
- **Test runner**: pytest (604 tests, 100% coverage)
...
├── tests/                 # 604 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 604 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 604 tests pass
