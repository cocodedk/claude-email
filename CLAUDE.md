...
- **Test runner**: pytest (577 tests, 100% coverage)
...
├── tests/                 # 577 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 577 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 577 tests pass
