...
- **Test runner**: pytest (460 tests, 100% coverage)
...
├── tests/                 # 460 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 460 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 460 tests pass
