...
- **Test runner**: pytest (883 tests, 100% coverage)
...
├── tests/                 # 876 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 883 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 883 tests pass
