...
- **Test runner**: pytest (547 tests, 100% coverage)
...
├── tests/                 # 547 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 547 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 547 tests pass
