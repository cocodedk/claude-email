...
- **Test runner**: pytest (1674 tests, 100% coverage)
...
├── tests/                 # 1674 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 1674 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 1674 tests pass
