...
- **Test runner**: pytest (1637 tests, 100% coverage)
...
├── tests/                 # 1637 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 1637 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 1637 tests pass
