...
- **Test runner**: pytest (479 tests, 100% coverage)
...
├── tests/                 # 479 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 479 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 479 tests pass
