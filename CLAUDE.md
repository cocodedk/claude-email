...
- **Test runner**: pytest (525 tests, 100% coverage)
...
├── tests/                 # 525 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 525 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 525 tests pass
