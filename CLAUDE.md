...
- **Test runner**: pytest (944 tests, 100% coverage)
...
├── tests/                 # 944 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 944 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 944 tests pass
