...
- **Test runner**: pytest (901 tests, 100% coverage)
...
├── tests/                 # 901 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 901 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 901 tests pass
