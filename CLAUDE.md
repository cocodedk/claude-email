...
- **Test runner**: pytest (912 tests, 100% coverage)
...
├── tests/                 # 912 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 912 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 912 tests pass
