...
- **Test runner**: pytest (932 tests, 100% coverage)
...
├── tests/                 # 932 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 932 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 932 tests pass
