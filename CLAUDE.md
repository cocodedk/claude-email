...
- **Test runner**: pytest (1108 tests, 100% coverage)
...
├── tests/                 # 1108 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 1108 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 1108 tests pass
