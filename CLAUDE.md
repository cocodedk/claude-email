...
- **Test runner**: pytest (340 tests, 100% coverage)
...
├── tests/                 # 340 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 340 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 340 tests pass
