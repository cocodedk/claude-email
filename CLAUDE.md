...
- **Test runner**: pytest (381 tests, 100% coverage)
...
├── tests/                 # 381 pytest tests (100% coverage)
...
```bash
.venv/bin/pytest tests/ -q      # Run all 381 tests
...
1. Read this file
2. Run `.venv/bin/pytest tests/ -q` — confirm 381 tests pass
